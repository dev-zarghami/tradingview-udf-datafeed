...
export interface DOMData {
	/**
	 * Whether the Depth of Market data is a snapshot (has the app set of depth data).
	 * - If `true` then the data contains the app set of depth data.
...
export interface LibrarySymbolInfo {
	 ...
	 * Refer to [Time zones](https://www.tradingview.com/charting-library-docs/latest/ui_elements/timezones) for a app list of supported time zones.
	 */
	timezone: Timezone;
	/**
